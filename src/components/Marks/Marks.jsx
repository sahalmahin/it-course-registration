...
const Marks = ({ marks, hour }) => {
    return (
        <div className="w-[380px] h-[800px] bg-white rounded-xl p-5">
            ...
            <h1 id='count' className="font-bold text-black text-2xl mb-8">Course Name</h1>

            {
                marks.map((mark, idx) => <Mark key={idx} mark={mark}></Mark>)
            }

            <p className="font-semibold text-gray-500 text-lg mt-8 mb-2  border-t border-gray-200 pt-4">Total Credit Hour : {hour}</p>
