...
const Marks = ({ marks }) => {
    return (
        <div className="w-[380px] h-[620px] bg-white rounded-xl p-5">
            ...
            <p className="font-semibold text-gray-500 text-lg mt-8 mb-2  border-t border-gray-200 pt-4">Total Credit Hour :</p>
